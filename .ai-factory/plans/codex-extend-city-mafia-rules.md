...
- [ ] **Task 4 — Implement ordered private night panels and storage-enforced role actions.**
...
- [ ] **Task 5 — Resolve the complete night deterministically and apply all winner conditions.**
...
- [ ] **Task 6 — Replace the one-round vote with durable city nominations, revote, alibi, and final decision flow.**
...
- [ ] **Task 7 — Update Telegram views, callback publishing, restoration, and test-game orchestration for the new rules.**
...
- [ ] **Task 8 — Add regression, concurrency, migration, and interaction coverage for city Mafia.**
...
- [ ] **Task 9 — Document the final city rules and perform the complete quality gate.**
